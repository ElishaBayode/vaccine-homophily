...
import_high_efficacy_low_trasm <- ggarrange(plot_ratio , plot_phil, plot_no_phil,  
          labels = c("A", "B", "C"),
          ncol = 3, nrow = 1)


ggsave(file="figures/import_high_efficacy_low_trasm.png",  
       import_high_efficacy_low_trasm, width = 12, height = 6)
...
import_low_efficacy_low_trasm <- ggarrange(low_plot_ratio , low_plot_phil,  low_plot_no_phil, 
          labels = c("A", "B", "C"),
          ncol = 3, nrow = 1)


ggsave(file="figures/import_low_efficacy_low_trasm.png",  import_low_efficacy_low_trasm, width = 12, height = 6)
