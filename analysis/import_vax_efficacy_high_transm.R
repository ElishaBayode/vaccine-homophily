...
import_high_effic_high_transm <- ggarrange(plot_ratio , plot_phil, plot_no_phil,  
          labels = c("A", "B", "C"),
          ncol = 3, nrow = 1)

ggsave(file="figures/import_high_effic_high_transm.png",  import_high_effic_high_transm, width = 12, height = 6)
...
import_low_effic_high_transm <- ggarrange(low_plot_ratio , low_plot_phil,  low_plot_no_phil, 
          labels = c("A", "B", "C"),
          ncol = 3, nrow = 1)


ggsave(file="figures/import_low_effic_high_transm.png",  import_low_effic_high_transm, width = 12, height = 6)
