...
beta = data.frame(beta=seq(0.1,0.24, length.out=10))
...
ggarrange(plot_ratio , plot_phil, plot_no_phil,  
          labels = c("A", "B", "C"),
          ncol = 3, nrow = 1)
...
low_ratio_phil_no_phil  <- long_form
...
ggarrange(low_plot_ratio , low_plot_phil,  low_plot_no_phil, 
          labels = c("A", "B", "C"),
          ncol = 3, nrow = 1)
